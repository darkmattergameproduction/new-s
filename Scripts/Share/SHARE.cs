...
public class SHARE : MonoBehaviour
{
    ...
    string subject = "SPRITE NINJA";
    string body = "https://play.google.com/store/apps/details?id=com.DarkMatterGames.SpriteNInja&hl=en";
 ...
 private static extern void sampleTextMethod (string message);
  ...
  sampleTextMethod (shareMessage);
    ...
    {
#if UNITY_ANDROID
        Application.OpenURL("https://play.google.com/store/apps/details?id=com.DarkMatterGames.SpriteNInja&hl=en&gl=US");
#elif UNITY_IPHONE
